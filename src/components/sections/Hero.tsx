    ...
    return (
      <>
        <div
          ref={heroElement}
          class={classNames(
            'prose max-w-full w-full font-sac flex flex-col justify-center p-8 min-h-max bg-red-200 fixed inset-x-0 top-0 z-10 font-script',
            props.class,
          )}
          style={{
          ...
          <h1 class="font-sac text-left text-5xl mx-auto my-auto relative py-2">
            ...
            <span
              ...
              style={{
                opacity:
                  Math.max(0, Math.min(100, heroHeight.value - 100)) / 100,
              }}>
              {yearText.value}
            </span>
          </h1>
